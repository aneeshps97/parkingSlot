...
public class ParkingAreaConroller {
    ...
    @PutMapping("/parkingArea/updateName/{id}")
    public ResponseEntity<Response<ParkingArea>> updateName(@PathVariable int id,
                                                            @RequestParam String newName){
        logger.info("Request received for changing name for parking area id::{} name::{}",id,newName);
        ParkingArea parkingArea=parkingAreaService.updateNameOfParkingArea(id,newName);
