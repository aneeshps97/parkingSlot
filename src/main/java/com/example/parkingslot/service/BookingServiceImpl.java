...
public class BookingServiceImpl implements BookingService {
    ...
    public Booking findByUserIdAndDate(int userId, String date, int pId) {
        return (Booking) bookingRepository.findByUserIdAndDateAndPId(userId, date,pId)
    ...
    public List<Booking> findSlotsByUserIdAndPId(int userId,int pId) throws Exception {
        List<Booking> bookings = bookingRepository.findByUserIdAndPId(userId,pId);
        if (bookings.isEmpty()) {
    ...
    public List<Booking> findByUserIdIsNullAndPId(int pId) throws Exception {
        List<Booking> unclaimedBookings = bookingRepository.findByUserIdIsNullAndPId(pId);
    ...
    public Booking releaseSlot(int slotId) throws Exception {
        Booking booking = bookingRepository.findById(slotId)
